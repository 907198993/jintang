...
import com.sk.jintang.module.orderclass.fragment.GoodsDetailXianShiFragment;
import com.sk.jintang.module.orderclass.fragment.GoodsEvaluateXianShiFragment;
import com.sk.jintang.module.orderclass.fragment.GoodsTuiJianXianShiFragment;
...
public class GoodsEvaluateXianShiActivity extends BaseActivity {
    ...
    private GoodsEvaluateXianShiFragment evaluateFragment;
    private GoodsDetailXianShiFragment detailFragment;
    private GoodsTuiJianXianShiFragment tuiJianFragment;
    ...
    protected int getContentView() {
        ...
        return R.layout.act_goods_evaluate_xian_shi;
    }

    @Override
    protected void initView() {
        goodsDetailObj = (GoodsDetailXianShiObj) getIntent().getSerializableExtra(Constant.IParam.goods);
        ...
        evaluateFragment = GoodsEvaluateXianShiFragment.newInstance(goodsDetailObj);
            ...
            public void onTabSelect(int position) {
                switch (position) {
                    case 0:
                        ...
                        hideFragment(tuiJianFragment);
                        break;
                    case 1:
                        if (detailFragment == null) {
                            detailFragment = GoodsDetailXianShiFragment.newInstance(goodsDetailObj);
                    ...
                    case 2:
                        if (tuiJianFragment == null) {
                            tuiJianFragment = GoodsTuiJianXianShiFragment.newInstance(goodsDetailObj);
                            getSupportFragmentManager().beginTransaction().add(R.id.fl_goods_detail, tuiJianFragment).commitAllowingStateLoss();
                        } else {
                            showFragment(tuiJianFragment);
                        }
                        hideFragment(evaluateFragment);
                        hideFragment(detailFragment);
                        break;
    ...
    @OnClick({R.id.app_right_iv,R.id.tv_goods_evaluate_name,R.id.ll_goods_evaluate_detail_kefu, R.id.ll_goods_evaluate_detail_collect, R.id.ll_goods_evaluate_detail_addshoppingcart, R.id.ll_goods_evaluate_detail_buy})
    ...
    private void buyGoods() {
        ...
        intent.putExtra(Constant.IParam.goodsId,goodsDetailObj.getGoods_id()+"");
    ...
    private void showGuiGe(List<GuiGeObj> list) {
        ...
        MyEditText tv_guige_num = guiGeView.findViewById(R.id.tv_guige_num);
