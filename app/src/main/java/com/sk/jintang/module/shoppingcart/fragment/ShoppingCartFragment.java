...
public class ShoppingCartFragment extends BaseFragment {
    ...
    protected void initView() {
        rv_shopping_tuijian.setFocusable(false);
        addShoppingCartBro = new AddShoppingCartBro(new AddShoppingCartBro.AddShoppingCartBroInter() {
            @Override
...
//        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(addShoppingCartBro, new IntentFilter(Config.Bro.addShoppingCart));
