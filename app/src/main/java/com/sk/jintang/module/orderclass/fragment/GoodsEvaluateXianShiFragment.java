...
public class GoodsEvaluateXianShiFragment extends BaseFragment implements LoadMoreAdapter.OnLoadMoreListener{
    ...
    public static GoodsEvaluateXianShiFragment newInstance(GoodsDetailXianShiObj obj) {
        Bundle args = new Bundle();
        args.putSerializable("obj", obj);
        GoodsEvaluateXianShiFragment fragment = new GoodsEvaluateXianShiFragment();
