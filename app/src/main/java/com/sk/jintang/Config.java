...
wx23ef688729e8e8ba*/
    ...
    //zhifubao-md5 werme5o1joth85cbbv2b9ej2sa01mexf
    ...
    public static final String qq_id = "1106212349";
    public static final String qq_key = "1GxmZJevyNSzH6dV";
    ...
    public static final String hxuser="hxuser";//环信账号
    public static final String hxpwd="hxpwd";//环信密码
    ...
    public static final String news_is_check="news_is_check";// (1未读显示红点 0已读不显示红点)
