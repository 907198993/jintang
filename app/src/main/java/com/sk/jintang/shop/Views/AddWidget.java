...
public class AddWidget extends FrameLayout {
	...
	private ShopDataObj.GoodsListBean foodBean;

	public interface OnAddClick {

		void onAddClick(View view, ShopDataObj.GoodsListBean fb);

		void onSubClick(ShopDataObj.GoodsListBean fb);
	}
	...
	public void setData(OnAddClick onAddClick, ShopDataObj.GoodsListBean foodBean) {
